class Messages:
    ...
    AMOUNT_TOO_SMALL = "红包总金额必须不少于份数（每份至少 1 个Pt）"
    MAX_COUNT_EXCEEDED = "红包份数不能超过 10000"
    INSUFFICIENT_BALANCE = "余额不足！你当前有 {balance} 个Pt"
    ...
    LIST_ITEM = (
        "{id}. {title} | Pt {remaining_amount}/{total_amount} | "
    ...
    CLAIM_SUCCESS = "恭喜你抢到 {amount} 个Pt！"
    CLAIM_COMPLETE = "{creator}的红包在{duration}内被抢完，{lucky_king}是手气王（{lucky_amount} 个Pt）！"
