...
- 开始游戏：`/黑香澄`
    - 想要直接下注的话，可以在命令后面加上数字哦！比如 `/黑香澄 10` 就是下注 10 个Pt～
- 查看帮助：`/黑香澄 -h` 或 `/黑香澄 help`

### 游戏流程 🎲

1. **开局时刻**：你和 Kasumi 各自拿到 2 张牌（不过 Kasumi 有 1 张是暗牌哦）。如果 Kasumi 的初始两张牌正好是 21 点，会立即亮牌并结算
...
- 拿到每手最初两张牌时，如果你觉得没有希望，可以立即投降；投降后会扣除一半的Pt，然后 Kasumi 获胜。
- 一旦选择过补牌，就不能再投降了。

#### 黑香澄 🎊

如果你一开始就抽到了传说中的 21 点，那恭喜你啦！这就是「黑香澄」，你会直接获胜，并且能得到丰厚的 1.5 倍下注Pt奖励哦～
...
Kasumi：
    ...
    7 + 4 + 10 = 21 点
    17 < 21，Kasumi 获胜！扣除你 10 个Pt，你现在还有 90 个Pt
```
