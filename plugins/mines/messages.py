class Messages:
    ...
    START = (
        "Kasumi 偷偷潜入到 Arisa 的地下室，开始搜刮Pt！\n"
    ...
    SAFE_REVEAL = "安全！Kasumi 捡到了Pt"
    HIT_MINE = "糟糕！被 Arisa 发现了，Pt全都被没收了"
    CASHOUT = "Kasumi 抱着Pt撤退啦！"
    ...
    ERROR = "发生意外错误了，已退还下注Pt，稍后再试试吧"

    HELP = (
        "【Arisa 的仓库探险指南】\n"
        "Arisa 的仓库里藏着许多珍贵的Pt，但她本人也在仓库里巡逻哦！\n"
        "帮助 Kasumi 避开 Arisa，尽可能多地搜刮Pt吧！\n\n"
        "基础指令：\n"
        "• 探险 [下注金额] [Arisa数量]\n"
        "  例如：探险 100 5\n"
